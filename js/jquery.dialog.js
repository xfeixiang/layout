        ...
        _show: function (title, msg, value, type, ishowbtn, callback) {
            ...
            switch (type) {
                case 'alert':
                    ...
                    $("body").append('<div id="popup_container_alert" class="modal-content animation" style="width: ' + $.dialog.width + ';height:' + $.dialog.height + ';top:' + $.dialog.top + ';left:' + $.dialog.left + '; margin: auto; overflow: hidden; position: absolute;_position:absolute; left: 300px; z-index: ' + max + '; border: 1px solid rgb(234, 234, 234); background: none repeat scroll 0% 0% rgb(255, 255, 255);min-width:300px;">' + '<h1  class="popup_title modal-header" style="padding: 0 0 10px; font-size:21px;"><div style="float:left;color:#eaeaea;width:16px;height:16px; margin: 10px 5px;" class="' + $.dialog.iconCls + '"></div><div class="popup_title_c" style="margin: auto; width: 90%;cursor:move;">' + title + '<span onclick="$.dialog._hide(\'popup_container_alert\', \'overflow_alert\')" style="float:right">X</span></div></h1>' + '<div id="popup_content_alert" class="modal-body" style="height:75%;" style="padding: 5px 0 15px 5px;">' + msg + '</div>' + '<div id="popup_message_alert"></div>' + '</div>');
                    if (ishowbtn) {
                ...
                case 'confirm':
                    ...
                    max = $.dialog._getCurrentZIndex();
                    $("body").append('<div id="popup_container_confirm" class="modal-content animation" style="width: ' + $.dialog.width + ';height:' + $.dialog.height + ';top:' + $.dialog.top + ';left:' + $.dialog.left + '; margin: auto; overflow: hidden; position: absolute; _position:absolute;left: 300px; z-index: ' + max + '; border: 1px solid rgb(234, 234, 234); background: none repeat scroll 0% 0% rgb(255, 255, 255);min-width:300px;">' + '<h1 class="popup_title modal-header" style="padding: 0 0 10px; font-size:21px;"><div style="float:left;color:#eaeaea;width:16px;height:16px; margin: 10px 5px;" class="' + $.dialog.iconCls + '"></div><div class="popup_title_c" style="margin: auto; width: 90%;cursor:move;">' + title + '<span onclick="$.dialog._hide(\'popup_container_confirm\', \'overflow_confirm\')" style="float:right">X</span></div></h1>' + '<div id="popup_content_confirm" class="modal-body" style="height:75%;">' + msg + '</div>' + '<div id="popup_message_confirm"></div>' + '</div>');
                    if (ishowbtn) {
                ...
                case 'window':
                    ...
                    max = $.dialog._getCurrentZIndex();
                    $("body").append('<div id="popup_container_window" class="modal-content animation" style="width: ' + $.dialog.width + ';height:' + $.dialog.height + ';top:' + $.dialog.top + ';left:' + $.dialog.left + '; margin: auto;min-width:300px; overflow: hidden; position: absolute;_position:absolute; left: 300px; z-index: ' + max + '; border: 1px solid rgb(234, 234, 234); background: none repeat scroll 0% 0% rgb(255, 255, 255);">' + '<h1  class="popup_title modal-header" style="padding: 0 0 10px; font-size:21px;"><div style="float:left;color:#eaeaea;width:16px;height:16px; margin: 10px 5px;" class="' + $.dialog.iconCls + '"></div><div class="popup_title_c" style="margin: auto; width: 90%;cursor:move;">' + title + '<span onclick="$.dialog._hide(\'popup_container_window\', \'overflow_window\')" style="float:right">X</span></div></h1>' + '<div id="popup_content_window" class="modal-body" style="height:75%;">' + msg + '</div>' + '<div id="popup_message_window"></div>' + '</div>');
